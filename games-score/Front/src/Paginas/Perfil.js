...
const [passwords, setPasswords] = useState({ actual: "", nueva: "" });
  ...
  const handleConfirmChanges = async () => {
    ...
    try {
      ...
      const response = await axios.put(`https://pw-2-7ybuch6af-leos-projects-ff2b9494.vercel.app/usuarios/editar/${idUsuario}`, {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      const response = await axios.put(`https://pw-2-7ybuch6af-leos-projects-ff2b9494.vercel.app/usuarios/cambiar-contrasena/${idUsuario}`, {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      const response = await axios.put(`https://pw-2-7ybuch6af-leos-projects-ff2b9494.vercel.app/usuarios/eliminar/${idUsuario}`);
      await MySwal.fire({
        icon: "success",
